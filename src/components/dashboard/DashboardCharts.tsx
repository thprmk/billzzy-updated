      ...
      <div className="mt-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="w-full bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
            <div className="p-4 pt-6 pb-0 pl-0">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6">
                <h2 className="text-lg pl-6 font-semibold text-gray-800">Sales Overview</h2>
          ...
          <Card className="w-full bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
          <div className="p-4 pt-6 pb-0 pl-0">
            <h2 className="text-lg pl-6 font-semibold text-gray-800 mb-6">Top Selling Products</h2>
