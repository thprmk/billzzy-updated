    ...
    <div className="w-full max-w-[650px] mx-auto px-6">
      <div className="relative w-full">
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          >
            {error && (
              <div className="bg-red-50 text-red-500 p-2 rounded-lg mb-3">
                {error}
              </div>
            )}
            ...
            {step === 2 && (
              <div className="grid gap-3 grid-cols-1 sm:grid-cols-2">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700">Flat/Shop No</label>
                  <Input type="text" name="flatNo" value={formData.flatNo} onChange={handleInputChange} required />
                </div>
                ...
                <div>
                  ...
                  <Input type="text" name="city" value={formData.city} onChange={handleInputChange} disabled />
                </div>

                <div>
                  <label className="block text-sm font-medium text-gray-700">District</label>
                  <Input type="text" name="district" value={formData.district} onChange={handleInputChange} disabled />
                </div>

                <div>
                  <label className="block text-sm font-medium text-gray-700">State</label>
                  <Input type="text" name="state" value={formData.state} onChange={handleInputChange} disabled />
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <Input type="url" name="websiteAddress" value={formData.websiteAddress} onChange={handleInputChange} />
                </div>
      ...
      <TrialModal isOpen={isTrialModalOpen} onClose={() => setIsTrialModalOpen(false)} onConfirm={handleTrialConfirm} />
